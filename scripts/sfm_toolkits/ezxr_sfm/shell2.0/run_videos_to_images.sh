...
PROJECT_PATH=/media/lzx/软件/lzx-data/C6
SRC_PATH=/media/lzx/软件/lzx-data/C6/videos
DST_PATH=/media/lzx/软件/lzx-data/C6/images
SMALL_DST_PATH=/media/lzx/软件/lzx-data/C6/images_ds
INTERVAL=20
SHORT_SIZE=640
IMAGE_LIST_SUFFIX=''
MULTITHREAD=true
